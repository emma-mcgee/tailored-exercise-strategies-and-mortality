...
%include 'fielpath\1_tte_pathways_data_prep_all_act.sas';
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_all_mort_all_act,
    covmeandata = results.covmean_all_mort_all_act,
	resultsdata = results.results_all_mort_all_act,
...
data results;
    merge results.results_all_mort_all_act n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_all_mort_all_act.xls"
  style=minimal
