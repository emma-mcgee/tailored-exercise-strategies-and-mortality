...
Purpose of Program: Run parametric g-formula for breast cancer mortality
                    Sensitivity analysis expanding the definition of serious 
                    conditions
****************************************************************************;
...
%include 'filepath\1_tte_pathways_strategies_xcond2.sas';
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    cov1  = xcond2,  cov1otype   = 2,  cov1ptype  = tsswitch1,
    ...
    savelib = results,
    survdata = results.simsurv_bc_mort_xcond2,
    covmeandata = results.covmean_bc_mort_xcond2,
	resultsdata = results.results_bc_mort_xcond2,
...
data results;
    merge results.results_bc_mort_xcond2 n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_bc_mort_xcond2.xls"
  style=minimal
