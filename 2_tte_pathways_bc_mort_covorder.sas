...
Purpose of Program: Run parametric g-formula for breast cancer mortality
                    Sensitivity analysis changing the order of timevarying 
                    covariates
****************************************************************************;
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    cov1  = wtlift_methr,    cov1otype = 4,   cov1ptype = lag1cat,   cov1knots = 0.5 1 2 5, cov1skip = 2 4,
    cov2  = xcond,  cov2otype   = 2,  cov2ptype  = tsswitch1,
    cov3  = lbmi,   cov3otype   = 3,  cov3ptype  = lag1spl,  cov3knots = 3.017 3.19990 3.51572 3.76491, cov3skip = 2 4,
    cov4  = aerobic_methr,    cov4otype   = 3,  cov4ptype  = lag1spl,  cov4knots = 7.78 19.55 49.67 83.59, cov4skip = 2 4,

    seed= 7865,

    savelib = results,
    survdata = results.simsurv_bc_mort_covorder,
    covmeandata = results.covmean_bc_mort_covorder,
	resultsdata = results.results_bc_mort_covorder,
...
data results;
    merge results.results_bc_mort_covorder n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_bc_mort_covorder.xls"
  style=minimal
