...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_bc_mort,
    covmeandata = results.covmean_bc_mort,
	resultsdata = results.results_bc_mort,
...
data results;
    merge results.results_bc_mort n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_bc_mort.xls"
  style=minimal
