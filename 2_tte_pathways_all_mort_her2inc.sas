...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_all_mort_her2inc,
    covmeandata = results.covmean_all_mort_her2inc,
	resultsdata = results.results_all_mort_her2inc,
...
data results;
    merge results.results_all_mort_her2inc n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_all_mort_her2inc.xls"
  style=minimal
