...
%include 'filepath\1_tte_pathways_data_prep_challenge.sas';
...
ods pdf file = "results/2_tte_pathways_all_mort_challenge.pdf";
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_all_mort_challenge,
    covmeandata = results.covmean_all_mort_challenge,
	resultsdata = results.results_all_mort_challenge,
...
data results;
    merge results.results_all_mort_challenge n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_all_mort_challenge.xls"
  style=minimal
