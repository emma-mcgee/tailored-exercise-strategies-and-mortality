...
%include 'filepath\1_tte_pathways_data_prep_challenge_can.sas';
...
ods pdf file = "results/2_tte_pathways_all_mort_challenge_stra.pdf";
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_all_mort_challenge_stra,
    covmeandata = results.covmean_all_mort_challenge_stra,
	resultsdata = results.results_all_mort_challenge_stra,
...
data results;
    merge results.results_all_mort_challenge_stra n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_all_mort_challenge_stra.xls"
  style=minimal
