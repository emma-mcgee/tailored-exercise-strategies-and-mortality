...
%include 'filepath\1_tte_pathways_strategies_prior.sas';
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_bc_mort_prior,
    covmeandata = results.covmean_bc_mort_prior,
	resultsdata = results.results_bc_mort_prior,
...
data results;
    merge results.results_bc_mort_prior n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_bc_mort_prior.xls"
  style=minimal
