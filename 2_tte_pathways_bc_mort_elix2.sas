...
Purpose of Program: Run parametric g-formula for breast cancer mortality
                    Sensitivity analysis requiring individuals to have a baseline 
                    Elixhauser co-morbidity index <2
****************************************************************************;
...
fixedcov = age_dx_cat_2 age_dx_cat_3 age_dx_cat_4 age_dx_cat_5 age_dx_cat_6
    ...
    savelib = results,
    survdata = results.simsurv_bc_mort_elix2,
    covmeandata = results.covmean_bc_mort_elix2,
	resultsdata = results.results_bc_mort_elix2,
...
data results;
    merge results.results_bc_mort_elix2 n_events(keep = COUNT);
...
ods tagsets.excelxp
  file = "results/2_tte_pathways_bc_mort_elix2.xls"
  style=minimal
